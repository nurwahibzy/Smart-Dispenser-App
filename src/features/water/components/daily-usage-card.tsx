...
export default function DailyUsageCard({ dailyUsage, totalDispenses }: DailyUsageCardProps) {
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 flex flex-col gap-3">
            ...
            <div>
                <p className="text-slate-400 text-xs uppercase tracking-wide mb-1">Penggunaan Harian</p>
                ...
                <p className="text-slate-400 text-xs mt-1">{totalDispenses} kali pemakaian hari ini</p>
            </div>
        </div>
    );
}
